...
for block_ in range(n_blocks):
    ...
    very_plotter.plot_bar(
        ...
        height=grp_lvl_stats_bw_sim_A[block]['mean_tr_over_subs'].values,
        colors=col_A, bar_width=half_bar_width)

    # Control agents
    very_plotter.plot_bar(
        ax=this_ax, x=[2.5, 3, 3.5],
        height=grp_lvl_stats_bw_sim_C[block]['mean_tr_over_subs'].values,
        colors=col_C, bar_width=half_bar_width,
        yerr=grp_lvl_stats_bw_sim_C[block]['std_tr_over_subs'],
        errorbar_size=3)

    # Configure axis
    very_plotter.config_axes(
        this_ax, y_label="Number of Treasures", y_lim=[0, n_tr_b],
...
for block in range(n_blocks):
    ...
    very_plotter.plot_bar(
        ...
        colors=col_C, bar_width=half_bar_width,
        yerr=grp_lvl_stats_bw_sim_C[block]['std_drills_over_subs'].values,
        errorbar_size=3)
...
very_plotter.plot_bar(
    ax=this_ax, x=[1, 1.5, 2],
    height=grp_lvl_stats_sim_100_A['mean_tr_over_b'].values,
...
very_plotter.plot_bar(
    ax=this_ax, x=[2.5, 3, 3.5],
    height=grp_lvl_stats_sim_100_C['mean_tr_over_b'].values,
    yerr=grp_lvl_stats_sim_100_C['std_tr_over_b'], colors=col_C,
...
very_plotter.plot_bar(
    ax=this_ax, x=[1, 1.5, 2],
    height=grp_lvl_stats_sim_100_A['mean_drills_over_b'].values,
    colors=col_A, bar_width=half_bar_width,
...
very_plotter.plot_bar(
    ax=this_ax, x=[2.5, 3, 3.5],
    height=grp_lvl_stats_sim_100_C['mean_drills_over_b'].values,
    colors=col_C, bar_width=half_bar_width,
